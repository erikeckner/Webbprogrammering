 ...
 * When we have inherited propterties of an object the foreach will not print out the inherited property whilst the for in loop will. 
...
function makeOptions(inv, prop) {
  ...
  const filteredProperties = Object.keys(inv).filter(name => inv[name][prop])
